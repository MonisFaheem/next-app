...
<h1 className='font-bold text-5xl'>You Will Grow, You Will <br /> Succeed. We Promise That</h1>
<p className='text-left pt-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo tempore nobis molestiae. Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet consectetur.</p>
...
<h4 className='font-bold text-3xl pt-10 justify-center items-center flex'>Contact Info</h4>
<p className='pt-5 flex justify-center items-center'>Lorem ipsum dolor sit amet.</p>
<form action="#">
  ...
  <div className='flex flex-col mt-7'>
    <label className='font-semibold' htmlFor="">Email Address</label>
    <input
    className='bg-white p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 mt-2'
    type="text" 
  ...
  <div className='flex flex-col mt-7'>
   ...
   className='bg-white p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 mt-2 mb-5 h-40'></textarea>
  </div>
  <CustomButton

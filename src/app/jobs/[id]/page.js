          ...
          <div>
            ...
            <div className="flex flex-wrap gap-6 mt-2 text-gray-700">
              <div className="flex items-center gap-2">
                <LuBriefcaseBusiness className="text-teal-600" /> {job.category}
              </div>
              <div className="flex items-center gap-2">
                <MdAccessTime className="text-teal-600" /> {job.type}
              </div>
              <div className="flex items-center gap-2">
                <LuWallet className="text-teal-600" /> {job.salary}
              </div>
              <div className="flex items-center gap-2">
                <IoLocationOutline className="text-teal-600" /> {job.location}
              </div>
            </div>
          </div>
        </div>
